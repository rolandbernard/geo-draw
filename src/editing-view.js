...
class EditingView extends LitElement {
    ...
    fetchData() {
        ...
        const data = path.match(new RegExp('#/edit/(.+)'))?.[1];
        if(!data) {
            // this.data = {
            //     // id: this.data_id++,
            //     // title: '',
